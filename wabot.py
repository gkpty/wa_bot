...
message_text='Este es un mensaje automatizado enviado por mi whats app bot' # message you want to send
no_of_message=1 # no. of time you want the message to be send
moblie_no_list=[50763304040] # list of phone number can be of any length
